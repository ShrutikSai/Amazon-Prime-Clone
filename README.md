...
This is a simple project where I created an Amazon Prime login page clone using only  HTML and CSS. <br>
...
Running the project is easy. The user only has to scroll up and down .<br>
